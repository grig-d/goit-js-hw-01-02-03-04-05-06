...
const copy = [...getSortedUniqueSkills(users)];
console.log(copy);
const copy2 = copy.filter(element, index, array);
console.log(copy2);

// accu.hasOwnProperty(tag);
// const onlinePlayers = players.filter(player => {return player.online;});
